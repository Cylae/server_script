...
The system architecture is based on Rust, providing high performance and safety.

## Security

Security is built-in by default, including firewall configuration and generated passwords.
