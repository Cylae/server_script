...
## 🏗 Architecture
Server Manager is built with a modular architecture leveraging Rust and Docker Compose.

## 🛡 Security
Security is a core focus, with automatically generated passwords, isolated networks, and UFW firewall configuration.
