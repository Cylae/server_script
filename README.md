...
| **Download** | QBittorrent | 8080 (Localhost), 6881 (TCP/UDP) | `http://localhost:8080` | Torrent Client |
...
| | Syncthing | 8384 (Localhost), 22000 (TCP/UDP), 21027 (UDP) | `http://localhost:8384` | File Synchronization |
...
| **Download** | QBittorrent | 8080 (Localhost), 6881 (TCP/UDP) | `http://localhost:8080` | Client Torrent |
| **Apps** | Nextcloud | 4443 (Localhost) | `https://localhost:4443` | Personal Cloud |
| | Vaultwarden | 8001 (Localhost) | `http://localhost:8001` | Password Manager |
| | Filebrowser | 8002 (Localhost) | `http://localhost:8002` | Web File Manager |
| | Yourls | 8003 (Localhost) | `http://localhost:8003` | URL Shortener |
...
| | Roundcube | 8090 (Localhost) | `http://localhost:8090` | Webmail |
| | Mailserver | 25, 143, 587, 993 | - | Full Mail Server |
| | Syncthing | 8384 (Localhost), 22000 (TCP/UDP), 21027 (UDP) | `http://localhost:8384` | Synchronisation de Fichiers |
