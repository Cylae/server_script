...
3. Login with your credentials. (Default: `admin` / randomly generated password - check terminal output or `secrets.yaml`)
...
3. Connectez-vous avec vos identifiants. (Défaut : `admin` / mot de passe généré aléatoirement - vérifiez la sortie du terminal ou `secrets.yaml`)
