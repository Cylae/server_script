...
*   `server_manager apply`: Applies configuration and deploys services (docker-compose up) without re-running system installations.
...
*   `server_manager apply` : Applique la configuration et déploie les services (docker-compose up) sans relancer les installations système.
